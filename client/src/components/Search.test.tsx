...
describe('Search', () => {
     ...
     it('renders Search', () => {
          render(<Search searchInput='Hello' setSearchInput={vi.fn()} handleSearch={vi.fn()} handleCancel={vi.fn()} toggleShowFavorites={vi.fn()}/>);
     });

     it('handles input changes appropriately', () => {
          let inputState = '';
          let setSearchInput = vi.fn().mockImplementation((val) => { inputState = val; });
          render(<Search searchInput='Hello' setSearchInput={setSearchInput} handleSearch={vi.fn()} handleCancel={vi.fn()} toggleShowFavorites={vi.fn()}/>);
     ...
     it('search & cancel button are binded to the correct props', () => {
          ...
          render(<Search searchInput='Hello' setSearchInput={vi.fn()} handleSearch={handleSearch} handleCancel={handleCancel} toggleShowFavorites={vi.fn()}/>);
